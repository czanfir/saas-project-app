class ProjectsController < ApplicationController
  ...
  before_action :set_tenant, only: [:show, :edit, :update, :new, :create, :users, :add_user]
  before_action :verify_tenant
  # GET /projects
  # GET /projects.json
  def index
    @projects = Project.by_user_plan_and_tenant_id(params[:tenant_id], current_user)
  end
  ...
  def add_user
    @project_user = UserProject.new(user_id: param[:user_id], project_id: @project.id)
    respond_to do |format|
